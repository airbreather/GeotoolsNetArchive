...
namespace Geotools.Geometries
{
	...
	public class NotRepresentableException : System.ApplicationException
	{
		...
		/// </summary>
		public NotRepresentableException() : base()
		{
		}

		/// <summary>
		/// Initializes a new instance of the NotRepresentableException class with a specified error message.
		/// </summary>
		/// <param name="message">A message that describes the error. </param>
		public NotRepresentableException(string message) : base(message)
		{
		}
		...
		public NotRepresentableException(SerializationInfo info,StreamingContext context) : base(info, context)
		{
		}
		...
		public NotRepresentableException(string message,	Exception innerException) : base(message, innerException)
		{
		}
	}
}
