...
namespace UrbanScience.Geographic.UnitTests.Geometries
{
	/// <summary>
	/// Summary description for EnvelopeTest.
	/// </summary>
	public class EnvelopeTest : TestCase
	{
//		double _x1 = 1.0;
//		double _y1 = 2.0;
//		double _x2 = 3.0;
//		double _y2 = 4.0;
		...
		/// <summary>
		/// Initializes a new instance of the EnvelopeTest class.
		/// </summary>
		public EnvelopeTest(String name) : base(name)
		{
		}
