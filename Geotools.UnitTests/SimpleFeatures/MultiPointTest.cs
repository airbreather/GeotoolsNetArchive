...
namespace Geotools.UnitTests.Geometries
{
	...
	/// </summary>
	public class MultiPointTest : TestCase
	{
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the MultiPointTest class.
		/// </summary>
		public MultiPointTest(String name) : base(name)
		{
		}
		#endregion
		...
		{
			//create a MultiPoint
			MultiPoint mp1 = Tester1();
			AssertEquals("Constructor-1: ", false, mp1.IsEmpty());
			AssertEquals("Constructor-1a: ", 23, mp1.GetNumPoints());

			//create a MultiPoint
			MultiPoint mp2 = Tester2();
			AssertEquals("Constructor-2: ", false, mp2.IsEmpty());
			AssertEquals("Constructor-2a: ", 18, mp2.GetNumPoints());

			//create a MultiPoint
			MultiPoint mp3 = Tester3();
			AssertEquals("Constructor-3: ", false, mp3.IsEmpty());
			AssertEquals("Constructor-3a: ", 21, mp3.GetNumPoints());

			//create a MultiPoint
			MultiPoint mp4 = Tester4();
			AssertEquals("Constructor-4: ", false, mp4.IsEmpty());
			AssertEquals("Constructor-4a: ", 32, mp4.GetNumPoints());
		}

		public void test_Clone()
		{
			//create a new multipoint
			MultiPoint mp = Tester1();
			//clone that multipoint
			MultiPoint mp2 = mp.Clone() as MultiPoint;

			//Test that they are not the same multipoint
			AssertEquals("Clone-1: ", false, mp==mp2);

			//Test that they have the same coordinates
			for(int i = 0; i < mp.GetNumGeometries(); i++)
			{
				AssertEquals("Clone-2: ", true, mp.GetCoordinate(i).X.Equals(mp2.GetCoordinate(i).X));
				AssertEquals("Clone-3: ", true, mp.GetCoordinate(i).Y.Equals(mp2.GetCoordinate(i).Y));
			}
		}
		...
		public void test_geometry()
		{
			...
			AssertEquals("geometry-1: ", 2.0, point.x);
			AssertEquals("geometry-1: ", 2.0, point.y);
		}
...
//			MultiPoint mp = Tester1();
//
//			AssertEquals("SetEmpty-1: ", false, mp.IsEmpty());
//			try
//			{
//				mp.SetEmpty();
...
//			}
		...
		public void test_Envelope()
		{
			...
			AssertEquals("Envelope-11: ", 0.0, coords[4].Y);
			...
			//make sure there is something in the envelope
			AssertEquals("Envelope-12: ", false, geom.IsEmpty());

			//get the coordinates out of the geometry
			coords = geom.GetCoordinates();
			//check the first set of coordinates (minX, minY)
			AssertEquals("Envelope-13: ", 7.0, coords[0].X);
			AssertEquals("Envelope-14: ", 13.0, coords[0].Y);

			//check the second set of coordinates (maxX, minY)
			AssertEquals("Envelope-15: ", 15.0, coords[1].X);
			AssertEquals("Envelope-16: ", 13.0, coords[1].Y);

			//check the third set of coordinates (maxX, maxY)
			AssertEquals("Envelope-17: ", 15.0, coords[2].X);
			AssertEquals("Envelope-18: ", 21.0, coords[2].Y);

			//check the forth set of coordinates (minX, maxY)
			AssertEquals("Envelope-19: ", 7.0, coords[3].X);
			AssertEquals("Envelope-20: ", 21.0, coords[3].Y);

			//check the fifth set of coordinates (minX, minY)
			AssertEquals("Envelope-21: ", 7.0, coords[4].X);
			AssertEquals("Envelope-22: ", 13.0, coords[4].Y);
			...
			//make sure there is something in the envelope
			AssertEquals("Envelope-23: ", true, geom.IsEmpty());
		}
...
//
//			AssertEquals("Extent2D1: ", 2.0, x1);
//			AssertEquals("Extent2D2: ", 2.0, y1);
//			AssertEquals("Extent2D3: ", 10.0, x2);
//			AssertEquals("Extent2D4: ", 9.0, y2);
//
...
//			AssertEquals("Extent2D4: ", 0.0, y2);
		...
		public void test_Project()
		{
			...
			//AssertEquals("Project: ", null, mp.Project(null));
		}
		...
		public void test_NumGeometries()
		{
			...
			AssertEquals("NumGeometries-1: ", 23, mp1.GetNumGeometries());
			AssertEquals("NumGeometries-2: ", 18, mp2.GetNumGeometries());
			AssertEquals("NumGeometries-3: ", 21, mp3.GetNumGeometries());
			AssertEquals("NumGeometries-4: ", 32, mp4.GetNumGeometries());
		}
		...
		public void test_IsEmpty()
		{
			...
			AssertEquals("IsEmpty1: ", false, mp.IsEmpty());
			...
			AssertEquals("IsEmpty2: ", true, mp2.IsEmpty());
		}
		...
		public void test_Dimension()
		{
			...
			AssertEquals("Dimension: ", 0, mp.GetDimension());
		}
		...
		public void test_IsSimple()
		{
			...
			AssertEquals("IsSimple-1: ", true, mp1.IsSimple());
			AssertEquals("IsSimple-2: ", false, mp2.IsSimple());
			AssertEquals("IsSimple-3: ", false, mp3.IsSimple());
			AssertEquals("IsSimple-4: ", false, mp4.IsSimple());
		}
		...
		public void test_CoordinateN()
		{
			...
			AssertEquals("CoordinateN-1: ", coord, mp1.GetCoordinate(2));
			coord = new Coordinate(5.0, 5.0);
			AssertEquals("CoordinateN-2: ", coord, mp1.GetCoordinate(5));
			coord = new Coordinate(11.0, 12.0);
			AssertEquals("CoordinateN-3: ", coord, mp1.GetCoordinate(12));
			coord = new Coordinate(11.0, 20.0);
			AssertEquals("CoordinateN-4: ", coord, mp1.GetCoordinate(20));
		}
		...
		public void test_Coordinates()
		{
			...
			{
				//AssertEquals("Coordinates-1: ", true, coords[i].Equals(_coords[i]));
			}
		}
		...
		public void test_NumPoints()
		{
			...
			AssertEquals("NumPoints1: ", 23, mp.GetNumPoints());
			...
			AssertEquals("NumPoints2: ", 0, mp2.GetNumPoints());
		}
		...
		public void test_GetBoundryDimension()
		{
			...
			AssertEquals("GetBoundryDimension: ", -1, mp.GetBoundaryDimension());
		}
		...
		public void test_Equals()
		{
			...
			MultiPoint mp = Tester1();
			MultiPoint testPoints1 = Tester1();

			//create a new multipoint to test for a false result
			MultiPoint testPoints2 = Tester2();

			//create a new type of geometry to test for another aoptional pest control procedure

			AssertEquals("EqualsTrue: ", true, mp.Equals(testPoints1));
			AssertEquals("EqualsFalse: ", false, mp.Equals(testPoints2));
		}
...
//These tests can only be run if the method CompareToSameClass is changed from protected to public
			//create new points
			MultiPoint mp = Tester3();

			//create a new multipoint to test against
			MultiPoint mp1 = Tester3();

			//create a new multipoint to test against
			MultiPoint mp2 = Tester1();

			//create a new multipoint to test against
			MultiPoint mp3 = Tester2();

			//create a new multipoint to test against
			MultiPoint mp4 = Tester4();		

			//Compare to a multipoint that is equal to the original multipoint
			AssertEquals("CompareToSameClass1: ", 0, mp.CompareToSameClass(mp1));

			//Compare to a multipoint that is greater than the original multipoint
			AssertEquals("CompareToSameClass2: ", -1, mp.CompareToSameClass(mp2));

			//Compare to a multipoint that is less than the original multipoint
			AssertEquals("CompareToSameClass3: ", 1, mp.CompareToSameClass(mp3));

			//Compare to a multipoint that is greater than the original multipoint
			AssertEquals("CompareToSameClass3: ", -1, mp.CompareToSameClass(mp4));
		}
...
//            AssertEquals("ComputeEnvInt1: ", 12.0, env.MaxX);
//			//the min y value for the multipoint
//			AssertEquals("ComputeEnvInt2: ", 1.0, env.MinX);
//
//			//the max x value for the multipoint
//			AssertEquals("ComputeEnvInt3: ", 22.0, env.MaxY);
//			//the min y value for the multipoint
//			AssertEquals("ComputeEnvInt4: ", 1.0, env.MinY);
//
...
//			AssertEquals("ComputeEnvInt5: ", -1.0, env2.MaxX);
...
//			AssertEquals("ComputeEnvInt7: ", -1.0, env2.MaxY);
