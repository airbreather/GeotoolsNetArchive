...
namespace Geotools.UnitTests.Geometries
{
	...
	/// </summary>
	public class DimensionTest : TestCase
	{
		/// <summary>
		/// Initializes a new instance of the DimensionTest class.
		/// </summary>
		/// <remarks>
		/// All the tests in this unit test are commented out cue to the protection level of dimension.
		/// </remarks>
		public DimensionTest(String name) : base(name)
		{
		}
