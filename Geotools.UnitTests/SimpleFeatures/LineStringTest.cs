...
namespace Geotools.UnitTests.Geometries
{
	...
	/// </summary>
	public class LineStringTest : TestCase
	{
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the LineStringTest class.
		/// </summary>
		public LineStringTest(String name) : base(name)
		{
		}
		#endregion
		...
		public void test_Clone()
		{
			...
			AssertEquals("Clone: ", true, ls.Equals(ls2));
		}
...
//			AssertEquals("SetEmpty-1: ", false, ls.IsEmpty());
//			try
//			{
//				ls.SetEmpty();
...
//			}
		...
		public void test_Point()
		{
            ...
            AssertEquals("Point-1: ", 5.0, point.x);
			AssertEquals("Point-2: ", 5.0, point.y);
		}
		...
		public void test_EndPoint()
		{
			...
			AssertEquals("EndPoint-1: ", true, point.Equals(point2));
			AssertEquals("EndPoint-2: ", false, point.Equals(point3));
		}
		...
		public void test_Envelope()
		{
			...
			AssertEquals("Envelope-3: ", 1.0, coords[0].Y);

			//check the second set of coordinates (maxX, minY)
			AssertEquals("Envelope-4: ", 12.0, coords[1].X);
			AssertEquals("Envelope-5: ", 1.0, coords[1].Y);

			//check the third set of coordinates (maxX, maxY)
			AssertEquals("Envelope-6: ", 12.0, coords[2].X);
			AssertEquals("Envelope-7: ", 22.0, coords[2].Y);

			//check the forth set of coordinates (minX, maxY)
			AssertEquals("Envelope-8: ", 1.0, coords[3].X);
			AssertEquals("Envelope-9: ", 22.0, coords[3].Y);

			//check the fifth set of coordinates (minX, minY)
			AssertEquals("Envelope-10: ", 1.0, coords[4].X);
			AssertEquals("Envelope-11: ", 1.0, coords[4].Y);
			...
			AssertEquals("Envelope-12: ", true, geom.IsEmpty());
		}
...
//			AssertEquals("Extent2D-1: ", 1.0, x1);
//			AssertEquals("Extent2D-2: ", 1.0, y1);
//			AssertEquals("Extent2D-3: ", 12.0, x2);
//			AssertEquals("Extent2D-4: ", 22.0, y2);
//
...
//
//			//check to be sure the proper extents are returned
//			AssertEquals("Extent2D-5: ", 1.0, x1);
//			AssertEquals("Extent2D-6: ", 1.0, y1);
//			AssertEquals("Extent2D-7: ", 10.0, x2);
//			AssertEquals("Extent2D-8: ", 14.0, y2);
		}
		...
		public void test_StartPoint()
		{
			...
			AssertEquals("StartPoint-1: ", true, point.Equals(point2));
			AssertEquals("StartPoint-2: ", false, point.Equals(point3));
		}
		...
		public void test_PointN()
		{
			...
			AssertEquals("PointN: ", true, testPoint.Equals(point));
		}
		...
		public void test_IsClosed()
		{
			...
			AssertEquals("IsClosed-1: ", false, ls1.IsClosed());
			AssertEquals("IsClosed-2: ", false, ls2.IsClosed());
			AssertEquals("IsClosed-3: ", true, ls3.IsClosed());
			AssertEquals("IsClosed-4: ", true, ls3.IsClosed());
		}
		...
		public void test_IsRing()
		{
			...
			AssertEquals("IsRing-1: ", false, ls1.IsRing());
			AssertEquals("IsRing-2: ", false, ls2.IsRing());
			AssertEquals("IsRing-3: ", true, ls3.IsRing());
			AssertEquals("IsRing-4: ", false, ls4.IsRing());
		}
		...
		public void test_IsEmpty()
		{
			...
			GeometryFactory gf = new GeometryFactory(_precMod, _sRID);
			LineString ls = gf.CreateLineString(coords);
			AssertEquals("IsEmpty-1: ", true, ls.IsEmpty());
			ls = SimpleOpen();
			AssertEquals("IsEmpty-2: ", false, ls.IsEmpty());
		}
		...
		public void test_Dimesion()
		{
			...
			AssertEquals("Dimension-1: ", 1, ls1.GetDimension());
			AssertEquals("Dimension-2: ", 1, ls2.GetDimension());
		}
		...
		public void test_IsSimple()
		{
			...
			AssertEquals("IsSimple-1: ", true, ls1.IsSimple());
			AssertEquals("IsSimple-2: ", false, ls2.IsSimple());
			AssertEquals("IsSimple-3: ", true, ls3.IsSimple());
			AssertEquals("IsSimple-4: ", false, ls4.IsSimple());
		}
		...
		public void test_NumPoints()
		{
			...
			AssertEquals("NumPoints-1: ", 22, ls1.GetNumPoints());
			AssertEquals("NumPoints-2: ", 18, ls2.GetNumPoints());
			AssertEquals("NumPoints-3: ", 21, ls3.GetNumPoints());
			AssertEquals("NumPoints-4: ", 32, ls4.GetNumPoints());
			AssertEquals("NumPoints-5: ", 0, ls5.GetNumPoints());
		}
		...
		public void test_GetCoordinates()
		{
			...
			AssertEquals("GetCoordinates-1: ", true, _coords.Equals(coords)); 
			AssertEquals("GetCoordinates-1: ", false, coords2.Equals(coords)); 
		}
		...
		public void test_CoordinateN()
		{
			...
			AssertEquals("CoordinateN-1: ", true, coord1.Equals(coord5));
			AssertEquals("CoordinateN-2: ", true, coord2.Equals(coord6));
			AssertEquals("CoordinateN-3: ", true, coord3.Equals(coord7));
			AssertEquals("CoordinateN-4: ", true, coord4.Equals(coord8));
		}
		...
		public void test_Equals()
		{
			...
			AssertEquals("Equals-1: ", true, ls1.Equals(ls3));
			//todo(Ronda): fix when geometry.equals is working
			AssertEquals("Equals-2: ", false, ls1.Equals(ls2));
			AssertEquals("Equals-3: ", true, ls3.Equals(ls1));
			AssertEquals("Equals-4: ", false, ls2.Equals(point));
		}
		...
		public void test_GetHashCode()
		{
			...
			AssertEquals("GetHashCode-1: ", true, hash1.Equals(hash3));
			AssertEquals("GetHashCode-2: ", true, hash3.Equals(hash1));
			AssertEquals("GetHashCode-3: ", false, hash1.Equals(hash2));
		}
		...
		public void test_ToString()
		{
			...
			AssertEquals("ToString-1: ", "LineString:(1, 2, NaN),(3, 4, NaN)", ls1.ToString());

			coord = new Coordinate(2.4, 4.9);
			coords.Add(coord);
			LineString ls2 = gf.CreateLineString(coords);
			AssertEquals("ToString-2: ", "LineString:(1, 2, NaN),(3, 4, NaN),(2.4, 4.9, NaN)", ls2.ToString());

			coord = new Coordinate(1.0, 1.0);
			coords.Add(coord);
			LineString ls3 = gf.CreateLineString(coords);
			AssertEquals("ToString-3: ", "LineString:(1, 2, NaN),(3, 4, NaN),(2.4, 4.9, NaN),(1, 1, NaN)", ls3.ToString());
		}
		...
		public void test_GeometryType()
		{
			...
			AssertEquals("GetType: ", "LineString", ls.GetGeometryType());
		}
		...
		public void test_Coordinates()
		{
			...
			{
				AssertEquals("Coordinates: ", true, coords[i].Equals(_coords[i]));
			}
		}
		...
		public void test_GetBoundary()
		{
			...
			AssertEquals("GetBoundary-1: ", false, geom.IsEmpty());

			AssertEquals("GetBoundary-2: ", 2, geom.GetNumPoints());
			...
			for(int i = 0; i < mp.GetNumPoints(); i++)
			{
				...
				{
					case 0:
						AssertEquals("GetBoundary-3: ", 1.0, mp.GetCoordinate(i).X);
						AssertEquals("GetBoundary-4: ", 1.0, mp.GetCoordinate(i).Y);
						break;
					case 1:
						AssertEquals("GetBoundary-5: ", 9.0, mp.GetCoordinate(i).X);
						AssertEquals("GetBoundary-6: ", 22.0, mp.GetCoordinate(i).Y);
						break;
					default:
			...
			AssertEquals("GetBoundary-7: ", true, geom.IsEmpty());

			AssertEquals("GetBoundary-8: ", 0, geom.GetNumPoints());

			//try on a nonsimple-open linestring
			ls = NonSimpleOpen();
			geom =  ls.GetBoundary();
            
			AssertEquals("GetBoundary-9: ", false, geom.IsEmpty());

			AssertEquals("GetBoundary-10: ", 2, geom.GetNumPoints());
			...
			for(int i = 0; i < mp.GetNumPoints(); i++)
			{
				...
				{
					case 0:
						AssertEquals("GetBoundary-11: ", 2.0, mp.GetCoordinate(i).X);
						AssertEquals("GetBoundary-12: ", 2.0, mp.GetCoordinate(i).Y);
						break;
					case 1:
						AssertEquals("GetBoundary-13: ", 3.0, mp.GetCoordinate(i).X);
						AssertEquals("GetBoundary-14: ", 9.0, mp.GetCoordinate(i).Y);
						break;
					default:
						Fail("This should never be reached");
						break;
			...
			AssertEquals("GetBoundary-15: ", true, geom.IsEmpty());

			AssertEquals("GetBoundary-16: ", 0, geom.GetNumPoints());
		}
		...
		public void test_GetBoundaryDimension()
		{
			...
			AssertEquals("GetBoundaryDimension: ", 0, ls.GetBoundaryDimension());
		}
		...
		public void test_CompareToSameClass()
		{
			...
			AssertEquals("CompareToSameClass-1: ", 0, ls.CompareToSameClass(ls2));
			AssertEquals("CompareToSameClass-2: ", 1, ls.CompareToSameClass(ls3));
			AssertEquals("CompareToSameClass-3: ", 1, ls.CompareToSameClass(mp));
			AssertEquals("CompareToSameClass-4: ", -1, ls3.CompareToSameClass(ls));
			AssertEquals("CompareToSameClass-5: ", -1, mp.CompareToSameClass(ls));
		}
	}
}
