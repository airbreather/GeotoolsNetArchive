...
namespace Geotools.UnitTests.Geometries
{
	...
	/// </summary>
	public class PolygonTest : TestCase
	{
		...
		/// <summary>
		/// Initializes a new instance of the PolygonTest class.
		/// </summary>
		public PolygonTest(String name) : base(name)
		{
		}
		...
		public void test_Constructor1()
		{
			...
			AssertEquals("Constructor1: ", false, polygon.IsEmpty());
		}

		public void test_Constructor2()
		{
			Polygon polygon = Poly2();
			AssertEquals("Constructor2: ", false, polygon.IsEmpty());
		}
		...
		public void test_Clone()
		{
			...
			AssertEquals("Clone: ", true, poly1.Equals(poly2));
		...
		public void test_InteriorRing()
		{
			...
			AssertEquals("InteriorRing-1: ", null, ilr);
			...
			for(int i = 0; i < ilr.GetNumPoints(); i++)
			{
				...
				AssertEquals("InteriorRing-2: ", true, point.Equals(point2));
			}
		}
...
//			Polygon poly2 = Poly2();
//
//			AssertEquals("SetEmpty-1:", false, poly1.IsEmpty());
//			AssertEquals("SetEmpty-2:", false, poly2.IsEmpty());
//
//			try
//			{
//				poly1.SetEmpty();
...
//			}
		...
		public void test_ExteriorRing()
		{
			...
			AssertEquals("ExteriorRing-1: ", true, lr.Equals(_exterior1));
			AssertEquals("ExteriorRing-2: ", false, lr.Equals(_exterior2));

			poly = Poly2();
			lr = poly.GetExteriorRing() as LinearRing;
			AssertEquals("ExteriorRing-3: ", true, lr.Equals(_exterior2));
			AssertEquals("ExteriorRing-4: ", false, lr.Equals(_exterior1));
		}
		...
		public void test_Envelope()
		{
			...
			AssertEquals("Envelope-1: ", coords[0], coords2[0]);
			AssertEquals("Envelope-2: ", coords[1], coords2[1]);
			AssertEquals("Envelope-3: ", coords[2], coords2[2]);
			AssertEquals("Envelope-4: ", coords[3], coords2[3]);
			AssertEquals("Envelope-5: ", coords[4], coords2[4]);
			...
			AssertEquals("Envelope-6: ", coords[0], coords2[0]);
			AssertEquals("Envelope-7: ", coords[1], coords2[1]);
			AssertEquals("Envelope-8: ", coords[2], coords2[2]);
			AssertEquals("Envelope-9: ", coords[3], coords2[3]);
			AssertEquals("Envelope-10: ", coords[4], coords2[4]);
		}
...
//			AssertEquals("Extent2D-1: ", 3.0, minX);
//			AssertEquals("Extent2D-2: ", 1.0, minY);
//			AssertEquals("Extent2D-3: ", 7.0, maxX);
//			AssertEquals("Extent2D-4: ", 5.0, maxY);
//
//			polygon = Poly2();
//			polygon.Extent2D(out minX, out minY, out maxX, out maxY);
//
//			AssertEquals("Extent2D-5: ", 7.0, minX);
//			AssertEquals("Extent2D-6: ", 13.0, minY);
//			AssertEquals("Extent2D-7: ", 15.0, maxX);
//			AssertEquals("Extent2D-8: ", 21.0, maxY);
		}
		...
		{
			Polygon poly = Poly1();
			AssertEquals("IsEmpty-1: ", false, poly.IsEmpty());

			Coordinates coords = new Coordinates();
			_gf = new GeometryFactory(_precMod, _sRID);
			LinearRing lr = _gf.CreateLinearRing(coords);
			poly = _gf.CreatePolygon(lr);
			AssertEquals("IsEmpty-2: ", true, poly.IsEmpty());
		}
		...
		public void test_Dimension()
		{
			...
			AssertEquals("Dimension: ", 2, poly.GetDimension());
		}
		...
		public void test_NumInteriorRings()
		{
			...
			AssertEquals("NumInteriorRings-1: ", 0, poly.GetNumInteriorRing());

			poly = Poly2();

			AssertEquals("NumInteriorRings-2: ", 1, poly.GetNumInteriorRing());
		}
		...
		public void test_IsSimple()
		{
			...
			AssertEquals("IsSimple-1: ", true, poly.IsSimple());
		}
		...
		public void test_Shell()
		{
			...
			AssertEquals("Shell-1: ", _exterior1, poly.Shell);

			poly = Poly2();

			AssertEquals("Shell-2: ", _exterior2, poly.Shell);
		}
		...
		public void test_Holes()
		{
			...
			AssertEquals("Holes-1: ", 0, poly.Holes.Length);

			poly = Poly2();

			AssertEquals("Holes-2: ", _interior2, poly.Holes[0]);
		}
		...
		public void test_Count()
		{
			...
			AssertEquals("Count-1: ", 26, poly.GetNumPoints());
		}
		...
		public void test_GeometryType()
		{
			...
			AssertEquals("GeometryType: ", "Polygon", poly.GetGeometryType());
		}
		...
		public void test_Coordinates()
		{
			...
			{
				AssertEquals("Coordinates-1: ", true, coords[i].Equals(_coords1[i]));
			}
			...
			for(int i = 0; i < coords.Count; i++)
			{
				AssertEquals("Coordinates-1: ", true, coords[i].Equals(_coords2[i]));
			}
		}
		...
		{
			Polygon poly = Poly1();
			AssertEquals("NumPoints-1: ", 9, poly.GetNumPoints());

			poly = Poly2();
			AssertEquals("NumPoints-2: ", 26, poly.GetNumPoints());
		}
		...
		public void test_GetBoundary()
		{
			...
			AssertEquals("GetBoundary-1: ", 1, mls.GetNumGeometries());
			AssertEquals("GetBoundary-2: ", 9, mls.GetNumPoints());
			Coordinates coords = mls.GetCoordinates();
			for(int i = 0; i < 9; i++)
			{
				AssertEquals("GetBoundary-3: ", true, coords[i].Equals(_exterior1.GetCoordinateN(i)));
			}
		}
		...
		{
			Polygon poly = Poly1();
			AssertEquals("GetBoundaryDimension:" , 1, poly.GetBoundaryDimension());
		}
		...
		public void test_Equals()
		{
			...
			AssertEquals("Equals: ", true, poly.Equals(poly));

			Polygon poly2 = Poly1();

			AssertEquals("Equals: ", false, poly.Equals(poly2));
		...
		public void test_CompareToSameClass()
		{
			...
			AssertEquals("CompareToSameClass-1: ", 0, poly1.CompareToSameClass(Poly1()));
			AssertEquals("CompareToSameClass-2: ", -1, poly1.CompareToSameClass(poly2));

			AssertEquals("CompareToSameClass-3: ", 0, poly2.CompareToSameClass(Poly2()));
			AssertEquals("CompareToSameClass-4: ", 1, poly2.CompareToSameClass(poly1));
		}
...
//			AssertEquals("ComputeEnvelopeInternal-1: ", 3.0, env.MinX);
//			AssertEquals("ComputeEnvelopeInternal-2: ", 1.0, env.MinY);
//			AssertEquals("ComputeEnvelopeInternal-3: ", 7.0, env.MaxX);
//			AssertEquals("ComputeEnvelopeInternal-4: ", 5.0, env.MaxY);
//
//			env = poly2.ComputeEnvelopeInternal();
//			AssertEquals("ComputeEnvelopeInternal-5: ", 7.0, env.MinX);
//			AssertEquals("ComputeEnvelopeInternal-6: ", 13.0, env.MinY);
//			AssertEquals("ComputeEnvelopeInternal-7: ", 15.0, env.MaxX);
//			AssertEquals("ComputeEnvelopeInternal-8: ", 21.0, env.MaxY);
		}
		...
		public void TestArea1()
		{
			...
			AssertEquals("Polygon area",25.0,area);
		}
		...
		public void TestArea2()
		{
			...
			Polygon polygon = (Polygon)_gf.CreateFromWKT(wkt);
			double area = polygon.GetArea();
			AssertEquals("Polygon area",24.0,area);
		}
		...
		public void TestArea3()
		{
			...
			Polygon polygon = (Polygon)_gf.CreateFromWKT(wkt);
			double area = polygon.GetArea();
			AssertEquals("Polygon area",0.0,area);
		}
	}
}
